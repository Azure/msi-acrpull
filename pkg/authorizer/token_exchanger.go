...
func ExchangeACRAccessTokenWithAuthResult(authResult base.AuthResult, tenantID, acrFQDN string) (types.AccessToken, error) {
	// Use AuthResult to exchange for ACR access token
