...
func (az *Authorizer) AcquireACRAccessTokenWithResourceID(identityResourceID string, acrFQDN string) (AccessToken, error) {
...
func (az *Authorizer) AcquireACRAccessTokenWithClientID(clientID string, acrFQDN string) (AccessToken, error) {
