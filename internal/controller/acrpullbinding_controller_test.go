...
func Test_ACRPullBindingController_reconcile(t *testing.T) {
	...
	for _, testCase := range []struct {
				...
				createSecret: &corev1.Secret{
					ObjectMeta: metav1.ObjectMeta{
						...
						Annotations: map[string]string{
							...
							"acr.microsoft.com/token.inputs":  "22xcczzccamzxpnpzuzes776qx9hc0r97keomc9lwybt",
						},
		...
		{
			name: "binding with pull credential updates the service account, honoring ordering guarantees",
			acrBinding: &msiacrpullv1beta1.AcrPullBinding{
				ObjectMeta: metav1.ObjectMeta{Namespace: "ns", Name: "binding", Finalizers: []string{"msi-acrpull.microsoft.com"}},
				Spec: msiacrpullv1beta1.AcrPullBindingSpec{
					ServiceAccountName: "delegate",
			...
			serviceAccount: &corev1.ServiceAccount{
				ObjectMeta:       metav1.ObjectMeta{Namespace: "ns", Name: "delegate"},
				ImagePullSecrets: []corev1.LocalObjectReference{{Name: "acr-pull-other"}},
			},
			pullSecrets: []corev1.Secret{{
				ObjectMeta: metav1.ObjectMeta{
					Namespace: "ns", Name: "binding-msi-acrpull-secret",
			...
			output: &action[*msiacrpullv1beta1.AcrPullBinding]{
				updateServiceAccount: &corev1.ServiceAccount{
					ObjectMeta:       metav1.ObjectMeta{Namespace: "ns", Name: "delegate"},
					ImagePullSecrets: []corev1.LocalObjectReference{{Name: "acr-pull-other"}, {Name: "binding-msi-acrpull-secret"}},
				},
			},
		},
		{
		...
		{
			name: "everything up-to-date, extraneous pull secret reference cleaned up",
			acrBinding: &msiacrpullv1beta1.AcrPullBinding{
				ObjectMeta: metav1.ObjectMeta{Namespace: "ns", Name: "binding", Finalizers: []string{"msi-acrpull.microsoft.com"}},
				Spec: msiacrpullv1beta1.AcrPullBindingSpec{
					ServiceAccountName: "delegate",
			...
			serviceAccount: &corev1.ServiceAccount{
				ObjectMeta:       metav1.ObjectMeta{Namespace: "ns", Name: "delegate"},
				ImagePullSecrets: []corev1.LocalObjectReference{{Name: "binding-msi-acrpull-secret"}, {Name: "binding-msi-acrpull-secret-whatever"}},
			},
			referencingServiceAccounts: []corev1.ServiceAccount{
				{
					ObjectMeta:       metav1.ObjectMeta{Namespace: "ns", Name: "delegate"},
			...
			pullSecrets: []corev1.Secret{{
				...
				ObjectMeta: metav1.ObjectMeta{
					Namespace: "ns", Name: "binding-msi-acrpull-secret-whatever",
					Labels: map[string]string{
						"acr.microsoft.com/binding": "binding",
					},
				},
		...
		{
			name: "everything up-to-date, extraneous pull secret cleaned up",
			acrBinding: &msiacrpullv1beta1.AcrPullBinding{
				ObjectMeta: metav1.ObjectMeta{Namespace: "ns", Name: "binding", Finalizers: []string{"msi-acrpull.microsoft.com"}},
				Spec: msiacrpullv1beta1.AcrPullBindingSpec{
					ServiceAccountName: "delegate",
		...
		},
		{
			...
			output: &action[*msiacrpullv1beta1.AcrPullBinding]{
				noop: &msiacrpullv1beta1.AcrPullBinding{
					ObjectMeta: metav1.ObjectMeta{Namespace: "ns", Name: "binding", Finalizers: []string{"msi-acrpull.microsoft.com"}},
					Spec: msiacrpullv1beta1.AcrPullBindingSpec{
						ServiceAccountName: "delegate",
					},
		...
		{
			name: "user changes ACR scope, regenerate",
			acrBinding: &msiacrpullv1beta1.AcrPullBinding{
				ObjectMeta: metav1.ObjectMeta{Namespace: "ns", Name: "binding", Finalizers: []string{"msi-acrpull.microsoft.com"}},
				Spec: msiacrpullv1beta1.AcrPullBindingSpec{
					ServiceAccountName: "delegate",
			...
			registerTokenCall: func(mock *mock_authorizer.MockInterface) {
				mock.EXPECT().AcquireACRAccessToken(
					...
					gomock.Eq(""),
					gomock.Eq("somewhere.else.biz"),
					gomock.Eq("repository:alice:pull")).
					Return(otherToken, nil).
					Times(1)
			},
			output: &action[*msiacrpullv1beta1.AcrPullBinding]{
				updateSecret: &corev1.Secret{
					ObjectMeta: metav1.ObjectMeta{
						...
						Annotations: map[string]string{
							"acr.microsoft.com/token.expiry":  otherExpiry.Format(time.RFC3339),
							"acr.microsoft.com/token.refresh": fakeClock.Now().Format(time.RFC3339),
							"acr.microsoft.com/token.inputs":  "e7zbhluhoceu823bs5pmdzhukvcbtj6khxsglgos92r",
						},
						OwnerReferences: []metav1.OwnerReference{
							{
								APIVersion:         "msi-acrpull.microsoft.com/v1beta1",
...
func TestPullSecretName(t *testing.T) {
	for _, testCase := range []struct {
		...
		{
			binding:  "small-and-reasonable",
			expected: "acr-pull-small-and-reasonable",
		},
		{
			binding:  "extremely-long-ebf8018b88187fa15444859cc3050ec7cb04ddc1ebf8018b88187fa15444859c-ebf8018b88187fa15444859cc3050ec7cb04ddc1ebf8018b88187fa15444859c-ebf8018b88187fa15444859cc3050ec7cb04ddc1ebf8018b88187fa15444859c-ebf8018b88187fa15444859cc3050ec7cb04ddc1ebf8018b88187fa15444859c",
			expected: "acr-pull-extremely-long-ebf8018b88187fa15444859cc3050ec7cb04ddc1ebf8018b88187fa15444859c-ebf8018b88187fa15444859cc3050ec7cb04ddc1ebf8018b88187fa15444859c-ebf8018b88187fa15444859cc3050ec7cb04ddc1ebf8018b88187fa15444859c-ebf8018b88187fa15444859-plvfti7qpc",
		},
	} {
		if actual, expected := pullSecretName(testCase.binding), testCase.expected; actual != expected {
