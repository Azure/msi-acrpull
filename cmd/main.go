...
func main() {
	...
	flag.Parse()
	allowedACRServerSuffixes := []string(allowedACRServerSuffixesFlag)
...
func (values *commaSeparatedStringSlice) String() string {
	if values == nil {
		return ""
	}
...
func (values *commaSeparatedStringSlice) Set(value string) error {
	*values = append(*values, commaSeparatedValues(value)...)
	return nil
}
