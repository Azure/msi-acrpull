...
func TestManagedIdentityPulls(t *testing.T) {
	...
	}, func(client crclient.Client, namespace, name string) func(ctx context.Context) (*msiacrpullv1beta1.AcrPullBinding, error) {
		return func(ctx context.Context) (*msiacrpullv1beta1.AcrPullBinding, error) {
...
func testACRPullBinding[B binding](
	...
	t.Run("pulls succeed with acrpullbinding", func(t *testing.T) {
		...
		if err := client.Create(ctx, createBinding(namespace, pullBinding, "", serviceAccount, cfg)); err != nil {
